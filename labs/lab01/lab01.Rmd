...
We will be keeping in-person lab attendance. Two unexcused absences are allowed.
...
* You need to enable the location access on your phone to check in.

### QR code for apple store: 

<center>

![Apple QR code](images/iClicker_Apple.png)
