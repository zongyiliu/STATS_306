...
| Name                  | Time                            |
|:----------------------|--------------------------------:|
| Yilei Zhang           |       Monday 8:00 am - 10:00 am |
| Jesse Wheeler         |     Wednesday 1:00 pm - 3:00 pm |
| Victor Verma          |     Thursday 12:00 pm - 2:00 pm |
| Benjamin Osafo Agyare |       Friday 12:00 pm - 2:00 pm |

## Attendance 

We will be keeping lab attendance. 

* If you can't make it to lab, just let us know in advance.
* If you missed class because you were sick then just let us know afterwards.

We will be keeping track of attendance via the iClicker app.

* The iClicker student app is free for both iOS and Android. 
* We will only be using it for attendance, so no subscription is required. 

### QR code for apple store: 

<center>

![Apple QR code](images/iClicker_Android.png)
...
![Android QR code](images/iClicker_Android.png)
...
Once you have the app, you need to either make a new account or sign in. 
If you are making a new account, try to match your name with your name as listed in Canvas. 

There are two ways you can join your iClicker attendance class: 

1. Your lab instructor provides you with a join code, which lets you join the lab
2. If your lab instructor permits it, you can search for the class in the app. 
...
- The form <OBJECT_NAME> = <OBJECT_VALUE> can also work, but isn't standard
- A name can contain letters, numbers, underscores, and dots
...
# your code here
x + y # x is numeric, y is a string, you can't add a string to a number
x + z # z is a logical value True, which is the same as 1.
```
...
- The vector is the basic data structure in R
- Two kinds of vectors:
  + Atomic vectors: each component is of the same type
  + Lists: components can be of different types
...
# Your code here
dat2 <- subset(dat, is_bender & grade>90)
dat2
```
