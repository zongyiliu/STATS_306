...
```{r package1, include=TRUE}
# run the first two lines if you have not installed the tidyverse and gapminder packages
...
Exercise 2: write a function to print the volume of a cylinder of radius $r$ cm, and height $h$ cm. $h$ and $r$ are the inputs of the function.
...
- Subsetting refers to extracting a part of parts of an object
...
```
You can get a better background by changing the theme:
