...
Provide a short summary of the data. How many columns are there? What kinds of data do we have? How many columns are quantitative? How many are nominal? Are there any dates or times?
...
Create two tibbles to create the table of lectures and topics on our [Syllabus page](https://umich.instructure.com/courses/554168/assignments/syllabus). In the first, use `tibble`. For the second, use `tribble`.
